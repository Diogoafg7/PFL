...
board(13, [
    ...
    [empty, empty, empty, empty, empty, empty, notused, notused, empty, empty, empty, empty, empty],
    [empty, empty, empty, empty, empty, notused, notused, notused, empty, empty, empty, empty, empty],
    [empty, empty, empty, empty, empty, notused, notused, notused, notused, empty, empty, empty, empty],
    [empty, empty, empty, empty, notused, notused, notused, notused, notused, empty, empty, empty, empty],
    [empty, empty, empty, empty, notused, notused, notused, notused, notused, notused, empty, empty, empty],
    [empty, empty, empty, notused, notused, notused, notused, notused, notused, notused, empty, empty, empty],
    [empty, empty, empty, notused, notused, notused, notused, notused, notused, notused, notused, empty, empty],
    [empty, empty, notused,  notused, notused, notused, notused, notused, notused, notused, notused, empty, empty]
    [empty, empty, notused, notused, notused, notused, notused, notused, notused, notused, notused, notused, empty ]
    [empty, notused, notused, notused, notused, notused, notused, notused, notused, notused, notused, notused, empty]
    [empty, notused, notused, notused, notused, notused, notused, notused, notused, notused, notused, notused, notused]
...
piece_info(block, player1, white).
piece_info(block, player2, black).
